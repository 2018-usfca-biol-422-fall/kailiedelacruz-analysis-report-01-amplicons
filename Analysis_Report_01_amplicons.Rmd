...
melted_obj %>%
  ...
  ggtitle("Percent Abundance of Phylum in All Key Samples") +
...
melted_obj %>%
  ...
  ggplot(aes(x = Phylum,
             ...
             fill = Phylum)) +
  geom_col(position = position_dodge()) +
  ggtitle("Percent Abundance of Phylum in Fkey Samples") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
# 
melted_obj %>%
  filter(sample_source == "Jkey") %>%
  ggplot(aes(x= Phylum,
             y = Abundance,
             fill = Phylum)) +
  geom_col(position = position_dodge()) +
  ggtitle("Percent abundance of Phylum in Jkey Samples") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
...
# 
melted_obj %>%
  filter(Phylum == "Fusobacteria") %>%
  ggplot(aes(x = Genus,
             y = Abundance,
             fill = Genus)) +
  geom_col(position = position_dodge()) +
  ggtitle("Percent abundance of Class in Samples Containing Fusobacteria") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1))
```
