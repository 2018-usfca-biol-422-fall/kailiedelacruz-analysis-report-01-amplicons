...
# Melt all files together. This creates one overall file that combines all of the data from the individual files. 
# Before melting, taxonomy information would be seen in a separate file than information about the samples. Using this
# function though, makes it so that you are only able to use dplyr and ggplot and not phyloseq 
