---
title: "Analysis Report 1: A Difference Between Bacterial Communities on Right Pointer Fingers Compared to Left Pointer Fingers in Looking at Taxonomy Through the Analysis of Data Obtained from a High-throughput Sequencing Method"
...
In analyzing the data from Fierer et al.'s study, my primary question was if there would be a noticeable difference in bacterial communities between fingers that use the left side of the keyboard vs. fingers that use the right side of the keyboard. Specifically, taking a look at the the bacterial communities in the Fkey samples vs. the Jkey samples would provide me with basic information about how bacterial communities differ generally between the two. Looking at both of these sample sets, I hypothesized that the bacterial communities would be the same or generally similar in terms of their taxonomy. Seeing a major difference between the bacterial phylum of the two key samples could ultimately provide information that relates to everyone. In further detail, getting a better idea about the difference in bacterial communities on the left fingertips in correspondence to the Fkey samples vs. the right fingertips in correspondence to the Jkey samples could provide a general idea about how bacteria differs on our left hands vs. the right. Relating this to the real world, this bacterial difference on our own hands can be significant through the fact that the use of our right hands differ from the use of our left hands and this can lead to different impacts on our health. 
